 ...
 * @author benny
 */
public class RemoveVOIDialog extends javax.swing.JDialog {
    Controller control = new Controller();
    /**
     * Creates new form RemoveExistingVOIDialog
     */
    public RemoveVOIDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RemovedVOIDialog dialog = new RemovedVOIDialog(new javax.swing.JFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveVOIDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
